...
<header>
        ...
        <div class="container header-2">
            ...
            <div class="d-flex align-items-center contact">
                ...
                <div class="d-flex flex-column text-right">
                    <a href=""><i class="fa-solid fa-envelope-circle-check text-white"></i> {{ setting('email') }}</a>
    ...
    <nav class="navbar navbar-expand-lg bg-orange menu">
        <div class="container">
        ...
        <div class="row py-5">
            <div class="col-md-6">
                <ul class="list-inline">
                    <li class="list-inline-item"><a href="{{ route('page', 'about-us') }}" class="text-white">О нас</a></li>
                    ...
                    <li class="list-inline-item"><a href="{{ route('page', 'contact') }}" class="text-white">Контакты</a></li>
                </ul>
